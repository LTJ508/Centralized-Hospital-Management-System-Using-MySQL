...
if(isset($_POST['delete'])){
	...
	if (mysqli_query($conn, $sql_delete_data)){
		echo "<script type=\"text/javascript\">window.alert('Consultation Hour Deleted Successfully..');window.location.href = '/chms/hospital/consultation.php';</script>";
	} 
	else{
